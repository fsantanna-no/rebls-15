...
We believe that the \code{traverse}, more than a simple convenience, 
dramatically reduces the complexity of programs, automatically handling a 
complex hierarchy of behaviors associated with recursive data types.
...
\begin{lstlisting}[title=CODE-1: \code{Queue} type]
data Queue with
  tag NIL ();
or
...
\begin{lstlisting}[numbers=left,xleftmargin=3.5em,title=CODE-3: Enqueuing commands]

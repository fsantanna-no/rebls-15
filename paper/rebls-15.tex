...
Johnicholas Hines \\
    ...
    \email{johnicholas-hines@idexx.com}
}
...
By lowering the barrier to writing custom nodes and leaves, \CEU makes behavior trees more flexible.
Furthermore, the \code{traverse} feature is necessary to retain the runtime-editable quality of behavior trees.

\subsubsection{Behavior trees as a contingent plan}

The leaves of a behavior tree in a blocksworld domain

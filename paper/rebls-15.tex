...
\keywords{Reactive Programming, Recursive Data Types, Structured Programming,
Behavior Trees, Domain Specific Languages, Incremental Computation, Logo}
...
A \code{traverse} block is tied with its associated data structure, ensuring bounded 

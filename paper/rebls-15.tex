...
\centering
\includegraphics[scale=0.17]{queue-20.eps}
\end{minipage}
\begin{minipage}[t]{0.24\linewidth}
\centering
\includegraphics[scale=0.17]{queue-21.eps}
\end{minipage}
\begin{minipage}[t]{0.24\linewidth}
\centering
\includegraphics[scale=0.17]{queue-22.eps}
\end{minipage}
\begin{minipage}[t]{0.24\linewidth}
\centering
\includegraphics[scale=0.17]{queue-23.eps}
\end{minipage}
\caption{
